...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_CREATE_EVT:
        ...
        gl_profile_tab[PROFILE_A_APP_ID].char_uuid_TX.len = ESP_UUID_LEN_128;
        //gl_profile_tab[PROFILE_A_APP_ID].char_uuid.uuid.uuid128 = GATTS_CHAR_UUID_TEST_TX;
        memcpy(&(gl_profile_tab[PROFILE_A_APP_ID].char_uuid_TX.uuid.uuid128), GATTS_CHAR_UUID_TEST_TX, ESP_UUID_LEN_128);
    ...
    case ESP_GATTS_ADD_CHAR_EVT: {
        ...
        if(c==0)
            gl_profile_tab[PROFILE_A_APP_ID].char_handle_TX = param->add_char.attr_handle;

        else if (c==1)
            gl_profile_tab[PROFILE_A_APP_ID].char_handle_RX = param->add_char.attr_handle;

        else ESP_LOGE(GATTS_TAG, "ILLEGAL ");
    ...
    case ESP_GATTS_CONNECT_EVT: {
        ...
        ble_connect.param = param;
        ble_connect.gatts_if = gatts_if;
